...
class SnakeGame extends SurfaceView implements Runnable{
    ...
    public void draw(){
        drawing.draw(state.isPaused(), getScore(),gameUpdate.getApple(),gameUpdate.getGapple(),gameUpdate.getPoison(),gameUpdate.getSnake(), getResources().getString(R.string.tap_to_play),gameUpdate.getObstacle());
